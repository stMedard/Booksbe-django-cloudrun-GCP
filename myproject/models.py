...
class Illustration(models.Model):
    ...
    user = models.ForeignKey(User, on_delete = models.RESTRICT, null = True, default= '')
...
class Book(models.Model):
    ...
    illustration = models.ForeignKey(Illustration, on_delete = models.PROTECT, null = True, blank = True)
    user_b = models.ForeignKey(User, on_delete = models.RESTRICT, blank=True, default = '')
...
class Chapter(models.Model):
    ...
    user_c = models.ForeignKey(User, on_delete = models.RESTRICT, blank=True, default = '')
    book = models.ForeignKey(Book, on_delete=models.RESTRICT, blank=True, default = '')
